...
var loggednValue = cookies.get("loggedIn")
var username = cookies.get('username'); 
var loginpage = cookies.get('page');
        	...
        	<Provider store={store}>
				...
				<BrowserRouter basename={'/'} >
					<ScrollContext>
                      ...
                      {this.state.loggedIn ? <Route exact path={`${process.env.PUBLIC_URL}/`} component={Kids}/> : <Route exact path={`${process.env.PUBLIC_URL}/`} component={Login}/> }
                             {/* Login Page Route */}
                            <Layout>
                                ...
                                {/* path for admin ui*/}
                                {/* <Route path={`${process.env.PUBLIC_URL}/admin`} component={AdminUi}/>  */}
                                ...
                                {/* Route for Old Mutual Admin Interface */}
                                {/* <Route path={`${process.env.PUBLIC_URL}/admin`} component={OmAdmin}/> */}
