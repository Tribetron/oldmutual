                                ...
                                <div className="col-lg-6">
                                    <div className="subscribe">
                                        <div>
                                            ...
                                            <p>Never Miss Any New Products From Old Mutual By Signing Up To Our Newsletter. </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                        ...
                        <div className="row footer-theme partition-f">
                            <div className="col-lg-4 col-md-6">
                                ...
                                <div className="footer-contant">
                                    ...
                                    <p>Look smart and cool with our wide range of products, specifically designed for you.  </p>
                                ...
                                <div className="sub-title">
                                    ...
                                    <div className="footer-contant">
                                        <ul>
                                            ...
                                            <li><Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`} >Mens</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="sub-title">
                                    ...
                                    <div className="footer-contant">
                                        <ul className="contact-list">
                                            <li><i className="fa fa-map-marker"></i>100 The Chase Emerald Hill, Harare <br></br>
                                            </li>
                                            <li><i className="fa fa-phone"></i>Call Us: (263) 778 303 153</li>
                                            <li><i className="fa fa-envelope-o"></i>Email Us: <a
                                                href="#">shop@oldmutual.com</a></li>
